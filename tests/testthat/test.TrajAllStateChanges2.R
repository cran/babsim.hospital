context("Additional trajectory tests to cover all possible state changes (1)")
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex34A
                        , conf = conf
                        , para = para)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex35A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    # less than 600
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex36A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    # less than 600
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex38A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    # less than 550
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex39A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    # less than 600
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex40A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex41A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex42A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex43A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex44A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
    ...
    s <- c(0,s)
    d <- diff(s)
    expect_equal(sum(d[d > 0]) , 100, tolerance= 0.2*N)
    # expectations beds:
    resources <- get_mon_resources(y)
    s <- resources[resources$resource=="bed",]$server
    s <- c(0,s)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex45A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex46A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex47A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
...
test_that("$N$ infected patients arrive.
  ...
  ", {
    ...
    conf$logLevel = 1    
    y <- babsimHospital(arrivalTimes = ex48A
                        , conf = conf
                        , para = para)
    # expectations intensive beds:
    resources <- get_mon_resources(y)
